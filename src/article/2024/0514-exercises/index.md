...
These are some of my working exercises for [Discrete Mathematics and Its Applications, 7th Ed., 2012](https://www.amazon.de/Discrete-Mathematics-Its-Applications-Rosen-dp-125967651X/dp/125967651X), Chapter 1.2 (Applications of Propositional Logic).

In this article, I will be using $\T$ for true and $\F$ for false as these signs help spot patterns more easily then the regular $T$ and $F$.
